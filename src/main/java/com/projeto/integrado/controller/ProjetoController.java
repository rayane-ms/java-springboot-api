...
public class ProjetoController {
	...
	@GetMapping("/info")
    public Projeto getProjetoDetails(){
        String projetoDescricao = (String) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        return projetoService.findByProjetoDescricao(projetoDescricao);
	}
