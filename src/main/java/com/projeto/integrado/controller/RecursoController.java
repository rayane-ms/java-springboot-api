...
public class RecursoController {
	...
	@GetMapping("/info")
    public Recurso getRecursoDetails(){
        String recursoNome = (String) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        return recursoService.findByRecursoNome(recursoNome);
	}
