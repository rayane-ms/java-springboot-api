...
public class TarefaController {
	...
	@GetMapping("/info")
    public Tarefa getStatusTarefaDetails(){
        StatusTarefa statusTarefa = (StatusTarefa) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        return tarefaService.findByStatusTarefa(statusTarefa);
    }
